from blueware.agent import (current_transaction, wrap_object,
...
class CursorWrapper(ObjectProxy):
    ...
    def __init__(self, cursor, dbapi2_module, connect_params, cursor_params):
        ...
        self._bw_dbapi2_module = dbapi2_module
        self._bw_connect_params = connect_params
        self._bw_cursor_params = cursor_params
...
class ConnectionWrapper(ObjectProxy):
    ...
    def cursor(self, *args, **kwargs):
        return self.__cursor_wrapper__(self.__wrapped__.cursor(
                *args, **kwargs), self._bw_dbapi2_module,
                self._bw_connect_params, (args, kwargs))
