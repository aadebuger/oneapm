...
from blueware.agent import (current_transaction,
        wrap_function_wrapper, ExternalTrace)
from blueware.hooks.external_httplib import httplib_connect_wrapper

def _bw_wrapper_make_request_(wrapped, instance, args, kwargs):
