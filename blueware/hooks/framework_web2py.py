...
from blueware.agent import (current_transaction, wrap_wsgi_application, wrap_external_trace,
                            wrap_function_trace, wrap_transaction_name, wrap_pre_function,
                            import_module, update_wrapper, wrap_object)
...
def instrument_gluon_compileapp(module):
    ...
    wrap_transaction_name(module, 'run_models_in',
...
def instrument_gluon_tools(module):
    ...
    wrap_external_trace(module, 'fetch',
    ...
    wrap_external_trace(module, 'geocode',
...
def instrument_gluon_http(module):
    ...
    wrap_pre_function(module, 'HTTP.to', transaction_name_name_not_found)
