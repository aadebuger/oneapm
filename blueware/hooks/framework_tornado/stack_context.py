...
def _bw_stack_context_wrap_wrapped_(request):
    ...
    return _bw_stack_context_function_wrapper_

def _bw_stack_context_wrap_wrapper_(wrapped, instance, args, kwargs):
    ...
    fn = FunctionWrapper(fn, _bw_stack_context_wrap_wrapped_(request))
