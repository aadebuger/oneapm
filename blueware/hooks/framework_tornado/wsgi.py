...
def _bw_wrapper_WSGIContainer___call__no_body_(wrapped, instance,
        args, kwargs):
...
def _bw_wrapper_WSGIContainer___call__body_(wrapped, instance, args, kwargs):
    # This variant of the WSGIContainer.__call__() wrapper is used when
...
def _bw_wrapper_WSGIContainer___call___(wrapped, instance, args, kwargs):
    ...
    if transaction is None:
        return _bw_wrapper_WSGIContainer___call__no_body_(wrapped, instance,
                args, kwargs)
    ...
    return _bw_wrapper_WSGIContainer___call__body_(wrapped, instance,
            args, kwargs)
...
def _bw_wrapper_WSGIContainer___init___(wrapped, instance, args, kwargs):
