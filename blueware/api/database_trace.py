...
def register_database_client(dbapi2_module, database_name,
    ...
    dbapi2_module._bw_database_name = database_name
    dbapi2_module._bw_quoting_style = quoting_style
    dbapi2_module._bw_explain_query = explain_query
    dbapi2_module._bw_explain_stmts = explain_stmts
    dbapi2_module._bw_instance_name = instance_name
...
def DatabaseTraceWrapper(wrapped, sql, dbapi2_module=None):
    ...
    def _bw_database_trace_wrapper_(wrapped, instance, args, kwargs):
    ...
    return FunctionWrapper(wrapped, _bw_database_trace_wrapper_)
