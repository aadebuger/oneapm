...
from blueware.core.database_utils import sql_statement, explain_plan
...
class DatabaseNode(_DatabaseNode):
    ...
    @property
    def product(self):
        return self.dbapi2_module._bw_database_name

    @property
    def instance(self):
        if (self.connect_params and
                self.dbapi2_module._bw_instance_name is not None):
            return self.dbapi2_module._bw_instance_name(*self.connect_params)
