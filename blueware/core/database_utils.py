...
class SQLDatabase(object):
    ...
    @property
    def name(self):
        return getattr(self.dbapi2_module, '_bw_database_name', None)
    ...
    def quoting_style(self):
        result = getattr(self.dbapi2_module, '_bw_quoting_style', None)
    ...
    def explain_query(self):
        return getattr(self.dbapi2_module, '_bw_explain_query', None)

    @property
    def explain_stmts(self):
        result = getattr(self.dbapi2_module, '_bw_explain_stmts', None)
